...
class SyncEsimAccessGlobalPackage extends Command
{
    protected $signature = 'esimaccess:sync-global-packages';
    protected $description = 'Sync Esim Access eSIM packages with local database';

    public function handle()
    {
        $this->info('Syncing Esim Access Global packages...');
        ...
        try {
            ...
            $this->info("Esim Access global package sync complete. Synced $count packages.");
        } catch (\Exception $e) {
