                        ...
                        <div className='flex items-center gap-6'>
                            ...
                            <div className='relative'>
                                {userReduxData?.image ? (
                                    ...
                                    <div className='from-primary to-secondary flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br text-2xl font-bold text-white shadow-lg md:h-24 md:w-24 md:text-3xl'>
                                ...
                                {navigationLinks.map((link, index) => (
                                    <Link
                                        ...
                                        className={`group flex items-center justify-between rounded-lg border p-4 transition-all duration-200 ${
                                            link.isActive
                                                ? 'text-primary border-blue-500 bg-blue-50'
                                            ...
                                            <div
                                                className={`flex h-10 w-10 items-center justify-center rounded-lg transition-colors ${
                                                    link.isActive
                                                        ...
                                                        : 'group-hover:text-primary bg-gray-100 text-gray-600 group-hover:bg-blue-100'
                                                }`}>
