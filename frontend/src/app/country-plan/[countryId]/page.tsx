            ...
            <div className='container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                ...
                <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
                    {packages.map((plan, index) => {
                        ...
                        const countryData = plan?.country?.find((c) => c.slug === countryId);
                        ...
                        return (
                            ...
                            //                         if (parent) {
                            //                             parent.innerHTML = `<span class="text-lg">${getCountryFlag(plan.country?.slice(0, 1)[0].country_code || countryData?.country_code || '')}</span>`;
                            //                         }
                            //                     }}
                            //                 />
                            //             </div>
                            ...
                            //                 {getCountryFlag(countryData?.country_code || '')}
                            //             </span>
                            //         )}
                            //         <div>
                            //             <h3 className='text-sm font-bold text-gray-900'>
                            //                 {countryData?.name || `${plan.name}`}
                            //             </h3>
