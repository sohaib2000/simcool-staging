...
const TravelDestinationTabs = () => {
    ...
    } = tokenBaseHandler<ApiResponse<Country>>({
        url: '/country'
    });

    const { data: regionApiData, refetch: refetchRegion } = tokenBaseHandler<ApiResponse<Region>>({
        url: '/regions',
        config: {
            cache: 'no-cache'
        }
                                ...
                                countries
                                    ...
                                    .map((country) => (
                                        <button
                                            ...
                                            aria-label={`Select ${country.name} - From US$${(Number(country.start_price) || 0).toFixed(2)}`}
                                                        ...
                                                        <div className='relative h-full w-full'>
                                                            {region?.image ? (
                                                                ...
                                                                <div className='flex h-12 w-12 items-center justify-center'>
                                                                    <FaGlobeAfrica className='h-12 w-12' />
                                                                </div>
                                                            )}
                                                        </div>
                                                    </div>
