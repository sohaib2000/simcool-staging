                    ...
                    {activeBanners.length === 1 ? (
                        ...
                        <div className='flex items-center justify-center lg:col-span-2'>
                            <Link
                                ...
                                className='group relative w-full max-w-2xl cursor-pointer overflow-hidden rounded-2xl shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl'>
                                {/* Main Image */}
