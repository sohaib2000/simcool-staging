        ...
        <div className='min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50'>
            <div className='container mx-auto max-w-6xl px-4 py-12'>
                ...
                <div className='mb-12 text-center'>
                    ...
                    <h1 className='text-primary mb-4 text-4xl font-bold md:text-5xl'>{privacyPolicyPage.title}</h1>
                ...
                <div className='bg-primary mb-12 rounded-2xl p-8 text-white shadow-xl'>
                ...
                <div className='mt-12 rounded-2xl bg-gray-50 p-8'>
                    <div className='text-center'>
                        <h3 className='text-primary mb-4 text-2xl font-bold'>Questions About Your Privacy?</h3>
                        ...
                        <div className='flex flex-col justify-center gap-4 sm:flex-row'>
                            <button
                                ...
                                className='bg-primary inline-flex items-center rounded-lg border border-gray-300 px-6 py-3 text-white transition-colors'>
