...
const DestinationModal: React.FC<DestinationModalProps> = ({ isOpen, onClose, onSelect }) => {
    ...
    const takeBaseHandler = userToken ? useProtectedApiHandler : usePublicApiHandler;
    const { data: countryData, refetch } = takeBaseHandler<ApiResponse>({
        url: '/country'
    });
    ...
    return (
        <Dialog open={isOpen} onOpenChange={handleOpenChange}>
            <DialogContent className='max-h-[90vh] max-w-lg gap-0 p-0'>
                <DialogHeader className='rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 p-6 pb-4'>
                ...
                {/* Modal Footer */}
                <div className='rounded-xl border-t border-gray-200 bg-gray-50 p-4'>
