            ...
            if (order.client_secret) {
                ...
                paymentContainer.innerHTML = `
                    <div style="text-align: center; margin-bottom: 20px;">
                        ...
                        <p style="margin: 0; color: #666; font-size: 14px;">Amount: ${order.currency} ${(Number(order.amount || 0) / 100).toFixed(2)}</p>
                    </div>
    ...
    const handlePaymentSuccess = async (payload: PaymentPayload): Promise<void> => {
        try {
            ...
            if (result?.success) {
                ...
                showAlertMessage('Payment Verified Successfully! ✅', 'warning');
