...
const PlanExploreModal: React.FC<PlanExploreModalProps> = ({ isOpen, onClose, packageId, onPurchase }) => {
    ...
    const dailyPrice = ((Number(packageDetails?.net_price) || 0) / (Number(packageDetails.day) || 1)).toFixed(2);
                        ...
                        <div className='grid grid-cols-1 gap-4 md:grid-cols-3'>
                            <div className='text-center'>
                                <div className='mb-2 flex items-center justify-center gap-2'>
                                    ...
                                    <span className='text-2xl font-bold'>{formatData(packageDetails.data)}</span>
                                </div>
                            ...
                            <div className='text-center'>
                                <div className='mb-2 flex items-center justify-center gap-2'>
                                    ...
                                    <span className='text-2xl font-bold'>
                                        {(Number(packageDetails.net_price) || 0).toFixed(2)}
                                    </span>
                                </div>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center gap-2'>
                                ...
                                <span className='text-sm text-gray-700'>
                                    {formatData(packageDetails.data)} Data Allowance
                                </span>
                            </div>
                            <div className='flex items-center gap-2'>
                                <CheckCircle className='h-4 w-4 text-green-500' aria-hidden='true' />
                ...
                <div className='border-t border-gray-200 bg-gray-50 p-6'>
                    <div className='flex flex-col items-center gap-3 sm:flex-row'>
                        ...
                        <div className='flex gap-3 sm:flex-shrink-0'>
                            <Button onClick={handlePurchase} className='bg-primary'>
